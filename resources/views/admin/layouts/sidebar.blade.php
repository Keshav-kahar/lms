  ...
  <div class="s7__sidebar-nav-wrapper" data-simplebar>
     <ul class="s7__sidebar-nav" id="s7__sidebar-nav">
        ...
        <li class="has-child">
          ...
          <span class="s7__nav-caption">{{__('Games')}}</span>
          </a>
          <ul class="s7__sub-nav" aria-expanded="false">
             @can('games-index')
             <li>
                <a class="sidebar-link" href="{{route('games.index')}}">
                <span class="s7__nav-caption">{{__('All Games')}}</span>
                </a>
             </li>
             @endcan
             @can('admin-games-log')
             <li>
                <a class="sidebar-link" href="{{route('admin.games.log')}}">
                <span class="s7__nav-caption">{{__('Games Log')}}</span>
                </a>
             </li>
             @endcan
          </ul>
