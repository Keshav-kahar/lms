...
Route::group(['middleware' => ['auth','ckstatus'],'namespace'=> 'User'], function() {
    ...
    Route::get('games-list', 'HomeController@gameIndex')->name('game.list.index');
    Route::get('games/{slug}', 'HomeController@gameDetails')->name('game.details.index');
    Route::post('roulette-post', 'HomeController@rouletteStore')->name('user.roulette.post');
    Route::post('slot-post', 'HomeController@slotStore')->name('user.slot.post');
...
Route::group(['middleware' => ['auth:admin'] ,'prefix' => 'admin','namespace'=> 'Admin'], function() {
    ...
    Route::group(['middleware' => 'permission'], function() {
        ...
        Route::get('games/log','GameController@gamesLog')->name('admin.games.log');
